...
The first scope describes the system itself.
...
A useful analogy is a multiplayer game engine. The engine defines what players and objects *can* do, but it does not require anyone to be actively playing.
...
Existing parsers, language indexes, and diagram renderers can be reused. The value of custom tooling is mainly in selecting and composing useful views rather than implementing a new renderer.
